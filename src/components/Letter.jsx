...
export default function EnvelopeAnimation() {
  ...
  return (
    <div className="flex h-screen w-full  flex overflow-y-auto font-sans text-slate-800">
      ...
      <div
        style={{
          backgroundImage: `url(${sunWebP})`,
          backgroundSize: "cover",
          backgroundPosition: "center",
          backgroundRepeat: "no-repeat",
        }}
        className="fixed top-20 right-20 w-80 h-80 rotate-10 rounded-xl animate-float"
      ></div>
      <div
        style={{
          backgroundImage: `url(${AirplaneWebP})`,
          backgroundSize: "cover",
          backgroundPosition: "center",
          backgroundRepeat: "no-repeat",
        }}
        className="fixed top-80 left-20 w-80 h-80 rotate-340 bg-cover rounded-xl animate-float-delayed"
      ></div>
        ...
        <div className="relative w-full h-full overflow-y-auto flex flex-col items-center pb-20">
          ...
          <div className="text-center mb-20 max-w-2xl mx-auto relative z-10">
            ...
            <p className="text-slate-600 text-lg md:text-xl leading-relaxed">
              I'm Tarang Verma, a passionate software engineer with a proven
              track record of delivering high-quality, scalable, and
          ...
          <div
            className={`relative w-full max-w-lg mx-auto transition-all duration-700 ease-in-out ${
              isLetterVisible ? "h-[700px] md:h-[600px]" : "h-[300px]"
            }`}
          >
              ...
              <div className="bg-[#fffbf0] rounded-sm shadow-2xl p-8 md:p-12 relative text-slate-800 rotate-1 hover:rotate-0 transition-transform duration-500">
                ...
                <div className="font-serif space-y-6 relative">
                  <div className="border-b-2 border-slate-100 pb-6 mb-6 flex justify-between items-end">
                    <div>
                      <p className="text-xs font-sans font-bold text-slate-400 uppercase tracking-widest mb-1">
                        From the desk of
                      </p>
                  ...
                  <h2 className="text-3xl font-bold text-slate-900 italic mb-6">
                  ...
                  <div className="bg-slate-50 p-6 rounded-lg border-l-4 border-orange-500 my-6 font-sans">
                    <p className="text-slate-600 italic font-medium leading-relaxed">
                      "I love to explore new tools and technology. I don't have
                      many hobbies outside coding. I am not athletic, bad at
                      singing, don't drink, can't dance. Building is the only
                      thing I am good at. At this point, I want to be a part of
                      taking something from 0 -&gt; 1 or 1 -&gt; 100. I just
                      want to be heads down chasing that goal."
                    </p>
                  </div>
                  ...
                  <div className="text-lg leading-relaxed space-y-4 text-slate-700">
                    <p>Hi,</p>
                    <p>
                      Really love to build cool stuff and wanted to reach out to
                      see if there were any openings for Software Engineers.
                    </p>
                    <p>
                      I have 1 year of relevant experience building full-stack
                      applications primarily data-driven at{" "}
                      <a
                      ...
                      as a part of their early teams where I helped scale
                      internal micro-services to thousands of workflows and
                      users.
                    </p>
                    <p>
                      Being a part of super lean teams, one of my strongest
                      suits has been the ability to work across the stack from
                      building scalable, robust backend systems to high
                      throughput data ingestion pipelines to production grade
                      frontend components in React.
                    </p>
                    <p>
                      I have built several end-to-end systems that involve
                      several layers at the intersection of UI
                      (Next.js/React.js), Backend (Python, Node + Go based
                      services using GraphQL and GRPC) as well as infrastructure
                      pieces (AWS + GCP over K8s) from building complex
                      workflows, DAG visualizations and drag and drop component
                      canvas for clients.
                    </p>
                    <p>
                      I would love to be a part of the team and define its work
                      and culture.
                    </p>
                  ...
                  <div className="pt-8 mt-8 border-t border-slate-100 flex justify-between items-center font-sans">
                    <div className="flex -space-x-2">
                      <div className="w-10 h-10 rounded-full bg-gray-200 border-2 border-white flex items-center justify-center text-xs text-gray-500">
                        TV
                      </div>
            ...
            <div
              ...
              className={`absolute left-1/2 transform -translate-x-1/2 bottom-0 w-full max-w-[500px] h-[300px] transition-all duration-500 
                ...
                ${
                  isLetterVisible
                    ? "translate-y-[200px] opacity-100 blur-0 scale-90 pointer-events-none"
                    : "translate-y-0"
                }
              `}
            ...
            >
              ...
              <div className="absolute inset-0 bg-amber-100 rounded-lg shadow-xl border-2 border-amber-200 overflow-hidden">
                ...
                <div
                  className={`absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-32 h-24 bg-gradient-to-br from-blue-300 to-blue-500 rounded-lg shadow-md flex items-center justify-center border-2 border-blue-600 rotate-3 transition-opacity duration-300 ${
                    isOpen ? "opacity-0" : "opacity-100 delay-300"
                  }`}
                >
                  <div className="text-white text-3xl font-bold italic opacity-80">
                    SR
                  </div>
                  <div className="absolute top-1 right-1 text-white text-xs font-semibold">
                    25¢
                  </div>
                ...
                <div
                  className={`absolute top-4 right-4 w-12 h-12 bg-gradient-to-tr from-green-300 to-emerald-400 rounded-full shadow-sm flex items-center justify-center border border-green-500 transition-opacity duration-300 ${
              ...
              >
                ...
                <div
                  className={`absolute top-[80%] left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-50 transition-opacity duration-300 ${
              ...
              <div className="absolute inset-0 z-20 pointer-events-none">
                ...
                <div
                  ...
                  style={{
                    ...
                    background:
                      "linear-gradient(45deg, #fef3c7 0%, #fffbeb 100%)",
                ...
                <div
                  ...
                  style={{
                    ...
                    background:
                      "linear-gradient(to top, #fde68a 0%, #fef3c7 100%)",
